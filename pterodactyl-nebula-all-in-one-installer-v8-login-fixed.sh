...
# ============================================================
# KAHFITZY NEBULA PRO PTERODACTYL v8
...
banner() {
  clear
  echo -e "${CYAN}╔════════════════════════════════════════════╗${NC}"
  echo -e "${CYAN}   KAHFITZY NEBULA PRO v8 - FULL CUSTOM UI  ${NC}"
...
/* ====================================================
   KAHFITZY NEBULA PRO v8 — Full UI injection
...
insert = """
    ...
    <link rel="stylesheet" href="/kahfitzy-nebula/nebula.css?v=8.0.0">
    <script defer src="/kahfitzy-nebula/nebula.js?v=8.0.0"></script>
...
menu() {
  while true; do
    ...
    echo "4. Re-Apply Nebula Pro v8 Theme"
    echo "5. Repair Panel"
