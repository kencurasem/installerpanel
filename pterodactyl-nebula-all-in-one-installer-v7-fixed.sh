...
# ============================================================
# KAHFITZY NEBULA PRO PTERODACTYL v7
...
banner() {
  clear
  echo -e "${CYAN}╔════════════════════════════════════════════╗${NC}"
  echo -e "${CYAN}   KAHFITZY NEBULA PRO v7 - FULL CUSTOM UI  ${NC}"
...
/* ====================================================
   KAHFITZY NEBULA PRO v7 — Full custom theme
...
/* ====================================================
   KAHFITZY NEBULA PRO v7 — Full UI injection
...
insert = """
    ...
    <link rel="stylesheet" href="/kahfitzy-nebula/nebula.css?v=7.0.0">
    <script defer src="/kahfitzy-nebula/nebula.js?v=7.0.0"></script>
...
for path in views.rglob('*.blade.php'):
    ...
    if new != text:
        backup = path.with_suffix(path.suffix + '.backup-kn-v7')
...
install_panel_custom() {
  ...
  echo ""
  ok "╔══════════════════════════════════════════╗"
  ok "  INSTALL SELESAI — KAHFITZY NEBULA PRO v7"
  ok "╚══════════════════════════════════════════╝"
...
menu() {
  while true; do
    ...
    echo "4. Re-Apply Nebula Pro v7 Theme"
    echo "5. Repair Panel"
